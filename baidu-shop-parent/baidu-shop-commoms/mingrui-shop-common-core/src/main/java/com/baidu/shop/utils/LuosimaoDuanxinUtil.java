...
public class LuosimaoDuanxinUtil {
    ...
    //短信平台的APIkey
    private static final String DUANXIN_API_KEY = "key-35a6ffbc65b06ab907254d82b8de79a4";//需要使用自己的APIkey
    private static final String SPEAK_API_KEY = "key-7678c85bfa1a093aaab0e70c40b0ae88";//需要使用自己的APIkey
