...
public class TemplateListener {
    ...
    @Autowired
    private TemplateStaticService templateStaticService;
    ...
    public void save(Message message, Channel channel) throws IOException {
        ...
        //根据spuId生成页面
        templateStaticService.createStaticHTMLTemplate(Integer.valueOf(new String(message.getBody())));
    ...
    public void delete(Message message, Channel channel) throws IOException {
        ...
        //根据spuid删除页面
        templateStaticService.delHTMLBySpuId(Integer.valueOf(new String(message.getBody())));
        channel.basicAck(message.getMessageProperties().getDeliveryTag(), true);
    }
